    ...
    return {
        initReviewTab: function(contextApp, messageContext, messageBar) {
            ...
            sitecore.on("change:messageContext", function() {
                ...
                contextApp.EmailPreviewRunEmailPreviewCheckButton.set('isEnabled', !messageContext.get("isReadonly"));
                contextApp.SpamCheckRunSpamCheckButton.set('isEnabled', !messageContext.get("isReadonly"));
