define([
    ...
    return DialogBase.extend({
        ...
        setupValidation: function() {
            ...
            this.FromAddressTextBox.on('change:text', function(textbox, emailAddress) {
        ...
        validateResponse: function (response, errorMessage) {
            var errorMessageId = errorMessage ? errorMessage.id : null;
            this.MessageBar.removeMessage(function (error) { return error.id === errorMessageId; });
        ...
        canSave: function() {
            ...
            ServerRequest(Constants.ServerRequests.CAN_SAVE_DEFAULT_SETTINGS, {
                ...
                success: function(response) {
                    if (this.validateResponse(response, invalidMessage)) {
                        defer.resolve();
                    } else {
                        defer.reject();
                    }
