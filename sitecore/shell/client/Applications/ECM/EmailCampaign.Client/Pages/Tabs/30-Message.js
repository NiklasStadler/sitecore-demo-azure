    ...
    function(
        ...
        var messageTab = sitecore.Definitions.App.extend({
            ...
            initialized: function() {
                ...
                this.isSubscriptionFromHTML = this.MessageContext.get("messageType") === "Subscription" &&
                    this.MessageContext.get("templateName") === "From HTML subscription";
                this.isExistingPageTemplate = this.MessageContext.get("templateId") ===
                    "{A89CF30C-EDFA-442E-8048-9234980E2176}"
                    ? true
                    : false;
                ...
                this.messageVariantsContext = {
                    currentContext: {
                        ...
                        variantId: this.MessageVariants.get("selectedVariant")
                            ? this.MessageVariants.get("selectedVariant").id
                            : null
                    },
                    app: this
                };
                var abTestingNotTriggeredNotSubscriptionHTML = this.isAbTesting &&
                ...
                this.setupPublishedItemsValidation();
                this.PublishedItemsValidation.validateAll();
            ...
            disableMessageVariantActions: function() {
                _.each(this.messageVariantActions,
                    function(action) {
                        action.disable();
                    });
            },
            ...
            setMessageVariantsState: function(state) {
                ...
                case "disabled":
                    ...
                    break;
                case "enabled":
                    this.setMessageVariantsState(this.MessageContext.get("isAbTesting")
                        ? "multivariate"
                        : "singlevariant");
                ...
                */
                ...
                this.MessageContext.on({
                        ...
                        "change:isReadonly": function() {
                            this.setMessageVariantsState(this.MessageContext
                                .get("isReadonly")
                                ? "disabled"
                                : "enabled");
            ...
            onAddVariant: function() {
                ...
                AddVariant.execute(this.messageVariantsContext,
                    _.bind(function(variant) {
                ...
                DialogService.show('confirm',
                    {
                        on: {
                            ok: _.bind(function() {
                                    this.MessageContext.set("isBusy", true);
                                    RemoveVariant.execute(this.messageVariantsContext,
                                        _.bind(function(variantId) {
                                                this.MessageVariants.removeVariant(variantId);
                                                this.MessageContext.set("variants",
                                                    this.MessageVariants.get("variants"),
                                                    { silent: true });
                                                this.MessageContext.set("isBusy", false);
                                                sitecore.trigger("change:messageContext");
                                            },
                        ...
                        text: sitecore.Resources.Dictionary
                            .translate("ECM.Pages.Message.AreYouSureYouWantToDeleteVariant"),
            ...
            onDuplicateVariant: function() {
                ...
                DuplicateVariant.execute(variantsContextClone,
                    _.bind(function(variant) {
                            this.MessageVariants.addVariant(variant);
                            this.MessageContext.set("variants", this.MessageVariants.get("variants"), { silent: true });
                            this.MessageContext.set("isBusy", false);
            ...
            setupPublishedItemsValidation: function() {
                this.PublishedItemsValidation = Validation.create({
                        id: 'PublishedItemsValidation',
                        highlightInput: false,
                        inputs: [
                            {
                                input: this.MessageVariants,
                                validators: {
                                    isItemsPablished: {
                                        method: _.bind(function() {
                                                var result = true;
                                                ServerRequest(constants.ServerRequests.PUBLISH_STATISTICS,
                                                    {
                                                        async: false,
                                                        data: {
                                                            messageId: this.MessageContext.get('messageId')
                                                        ...
                                                        success: function(response) {
                                                            if (response &&
                                                                response.publishStatistics &&
                                                                response.publishStatistics.imagesUnpublished) {
                                                                result = false;
                                                            }
                                                        }
                                                    });
                                        ...
                                        message: sitecore.Resources.Dictionary
                                            .translate('ECM.Pages.Message.IfYouHaveUploadedImagesUsingMediaUploader')
                                    }
                                }
                            }
                        ]
                    ...
                    .on({
                            'validation:input:error': function(message) {
                                ...
                                this.MessageBar.addMessage("warning",
                                    _.extend({ actions: [], closable: true }, message));
                            },
