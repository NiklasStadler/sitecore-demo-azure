  ...
  var model = sitecore.Definitions.Models.ControlModel.extend({
    ...
    successRecipients: function (data) {
      ...
      for (var i = 0; i < recipients.length; i++) {
          recipients[i].url = "/sitecore/client/Applications/ExperienceProfile/contact?cid=" + (recipients[i].itemId || recipients[i].Id);
      }
    ...
    refreshRecipients: function (recipientLists) {
      ...
      for (var i = 0; i < this.recipientListsToBindRecipients.length; i++) {
          recipientListIds.push(this.recipientListsToBindRecipients[i].itemId || this.recipientListsToBindRecipients[i].Id);
      }
    ...
    nextRecipients: function () {
      ...
      _.each(recipientLists, function (recipientList) {
          recipientListIds.push(recipientList.itemId || recipientList.Id);
      });
