define([
    ...
    var model = sitecore.Definitions.Models.ControlModel.extend({
        ...
        attachEventHandlers: function() {
            var debouncedRefresh = _.debounce(_.bind(this.refresh, this), 100);
            sitecore.on({
                "change:messageContext": function(messageContext) {
                    if (messageContext) {
                        debouncedRefresh(messageContext);
                    }
                },
                "recipientLists:added": debouncedRefresh,
                "recipientLists:removed": debouncedRefresh,
        ...
        refresh: function(messageContext) {
            ...
            ServerRequest(Constants.ServerRequests.MESSAGE_INFO, {
                data: { messageId: this.get("messageId"), utcOffset: new Date().getTimezoneOffset(), language: language },
